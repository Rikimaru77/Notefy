  ...
  if (!isLoggedIn) {
    ...
    <> 
      ...
      <main className="text-box">
        <p>Please login or register to your account to get access to your notes.</p>
        <button id="login-button">login</button>
        <button id="register-button">register</button>
      </main>
      <footer>
        developed by the&nbsp;<a href="https://www.wildcodeschool.com/" className="wcs" target="_blank" rel="noopener noreferrer" > Wild Code School </a>
      </footer>
    </>
  );
}
